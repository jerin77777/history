...
class Server {
  ...
  // String host = "https://test.loca.lt";
  // String host = "https://5c05-103-130-204-132.ngrok-free.app";
...
// files
  uploadFile(
    ...
    var multipartFile =
        http.MultipartFile('file', stream, fileSize, filename: jsonEncode({"name": fileName, "id": sessionId}));
